...
class ActorCritic(nn.Module):
    def __init__(self, input_shape, num_actions, discrete):
        ...
        self.actor_linear = init_(nn.Linear(self.feature_size(input_shape), num_actions))
    ...
    def feature_size(self, input_shape):
        if hasattr(self, "hidden"):
            assert hasattr(self, "conv5")  # Special case for cCarRacing-v0 only!
            return 100
        return self.conv4(self.conv3(self.conv2(self.conv1(
